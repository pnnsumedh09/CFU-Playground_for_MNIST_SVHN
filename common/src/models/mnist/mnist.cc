...
#include "menu.h"
#include "models/mnist/image_0.cc"
#include "models/mnist/image_1.cc"
#include "models/mnist/image_2.cc"
#include "models/mnist/model_mnist.h"
#include "tflite.h"
...
static void mnist_init(void) {
  tflite_load_model(model_mnist, model_mnist_len);
}
